        ...
        <div className="Modal__content">
          ...
          <div className="Modal__body">
            ...
            <p className="my-4 text-blueGray-500 md:text-lg leading-relaxed">
              <b>Description:</b>
              &quot;Son of Peria Sahara&quot; is the game that I designed and coded using Unity
               and Meta Quest 2 headsets. It&apos;s an action-adventure game based on a Persian myth.
            </p>
            ...
            <ul className=" text-sm md:text-base ml-2 list-disc list-inside text-gray-600">
              <li>Worked with Unity <b>XR toolkit</b> to develop a fully functional VR game.</li>
              <li>Implemented bow and arrow physics and mechanics in C#.</li>
              <li>Created a nice environment and atmosphere using Unity Engine.</li>
            </ul>
          </div>
